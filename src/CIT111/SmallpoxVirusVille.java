 ...
 * @author micro
 */
public class SmallpoxVirusVille {
    public static void main(String[] args) {
        // create a new instance of a Virus object with the keyword: new
        Virus Smallpox = new Virus();
        // set member variables on the instance of Virus stored in Herpes
        Smallpox.Baltimore = "I";
        Smallpox.Order = "Not defined";
        Smallpox.Family = "Poxviridae";
        Smallpox.Genus = "Orthopoxvirus";
        Smallpox.Tropism = "Immune cells";
        Smallpox.HumanOnly = true;
        Smallpox.Envelope = true;
        Smallpox.GenomeSize = 250;
        
         // send our Car instance to a helper method to print its member variables
    displayVirusStats(Smallpox);
    // test its methods
    Smallpox.startReplication();
    Smallpox.notReplicating();
    Smallpox.getCurrentSpeed();
...
} // close class SmallpoxVirusVille